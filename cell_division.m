function [cells] = cell_division(I,arg)
...
%     box off;
    ...
    for i = 1:cell_height:h
        for j = 1:cell_width:w
            ...
            %hist1 = histogram(I(i:limit_i, j:limit_j), arg(i:limit_i, j:limit_j), nb_bins, 'EdgeColor', 'none', 'FaceColor','red')
            [counts,binLocations] = imhist(I(i:limit_i, j:limit_j),nb_bins);
            cells(counter,:) = reshape(counts,1,[]);
